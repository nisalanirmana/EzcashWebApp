...
<body>
 <div>
	        <h3 style="margin-left:2px;font-family: Palatino Linotype;text-align: left;" >Operators</h3>
	    ...
	    <thead>
	       ...
	       <thead>
	          <tbody> 	
	        	...
	        	<tr>
	        	   <td ><a href="<c:url value='/editOperator/${op.operatorId}' />" ><img src="<c:url value='/resources/img/edit.png'/>" /></a></td>
	        		<td><a href="<c:url value='/removeoperator/${op.operatorId}' />" ><img src="<c:url value='/resources/img/delete.png'/>" /></a></td>
	        		<td>${op.operatorId}</td>
			...
			<td><input type="text" style="width:80%" class="text" name="phoneNumber" value="${operatorAttribute[0].phoneNumber}" required></td>
			<td><input type="text" style="width:80%" class="text" name="email" value="${operatorAttribute[0].email}" required></td>
			<td>
