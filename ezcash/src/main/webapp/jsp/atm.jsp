...
<!-- Auto Refresh JSP Pages -->
    ...
    <body>
	        ...
	        <h3 style="margin-left:2px;font-family: Palatino Linotype;text-align: left;" >Basic Details</h3>
...
<form action="<c:url value="/rebootatm/${AtmTab}" />" method="GET">
    <input type="submit" name="action" value="Reboot ATM" />
				  ...
				  <h3 style="margin-left:2px;font-family: Palatino Linotype;text-align: left;" >Alerts</h3>
