    ...
    <ul>
        		...
        		<div class="link_title">
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/overview.png'/>" />
            				...
            				<spring:url value="/authenticated" var="authenticatedUrl" htmlEscape="true"/>
            					
            					<a href="${authenticatedUrl}" class="a ${sessionScope.MenuTab eq 'system'?'currentTab':'Tab'}"><span>Overview</span></a>
        			...
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/atm.png'/>" />
            				...
            				<spring:url value="/atmList" var="atmUrl" htmlEscape="true"/>
            					<a href="${atmUrl}" class="a ${sessionScope.MenuTab eq 'atm'?'currentTab':'Tab'}"><span>ATM</span></a>
        ...
        <li class="var_nav">
        	<div class="link_bg"></div>
        		<div class="link_title">
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/transaction.png'/>" />
        			</div>
            				<spring:url value="/transaction" var="transactionUrl" htmlEscape="true"/>
            					<a href="${transactionUrl}" class="a ${sessionScope.MenuTab eq 'transaction'?'currentTab':'Tab'}" ><span>Transaction</span></a>
            	</div>				
        </li>
        			...
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/users.png'/>" />
            				...
            				<spring:url value="/users" var="usersUrl" htmlEscape="true"/>
            					<a href="${usersUrl}" class="a ${sessionScope.MenuTab eq 'users'?'currentTab':'Tab'}"><span>Users</span></a>
            	</div>				
        </li>
        <li class="var_nav">
        	<div class="link_bg"></div>
        			...
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/operators.png'/>" />
            				...
            				<spring:url value="/operators" var="operatorsUrl" htmlEscape="true"/>
            					<a href="${operatorsUrl}" class="a ${sessionScope.MenuTab eq 'operators'?'currentTab':'Tab'}"><span>Operators</span></a>
            	</div>				
        </li>
         ...
         <li class="var_nav">
        	<div class="link_bg"></div>
        		<div class="link_title">
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/maintenance.png'/>" />
        			</div>
            				<spring:url value="/maintenance" var="maintenanceUrl" htmlEscape="true"/>
            					<a href="${maintenanceUrl}" class="a ${sessionScope.MenuTab eq 'maintenance'?'currentTab':'Tab'}"><span>Maintenance</span></a>
            	</div>				
        </li>
        			...
        			<div class=icon> 
        				<img src="<c:url value='/resources/img/menu_icon/alerts.png'/>" />
            				...
            				<spring:url value="/alerts" var="alertsUrl" htmlEscape="true"/>
            					<a href="${alertsUrl}" class="a ${sessionScope.MenuTab eq 'alerts'?'currentTab':'Tab'}"><span>Alerts</span></a>
            	</div>				
        </li>
       <!--  
         <li class="var_nav">
