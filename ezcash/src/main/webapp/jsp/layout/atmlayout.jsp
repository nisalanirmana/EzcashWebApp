...
<body>
	...
	<table border="0" align="center" width="1024">
		...
		<tr>
			...
			<td width="124" height="520" valign="top"><tiles:insertAttribute
					name="atmlist" /></td>


			<td valign="top" width="776" bgcolor="#EBF2FA"><tiles:insertAttribute
					name="body" /></td>
		...
		<tr>
			<td colspan="3" bgcolor="#f0f0ee"><tiles:insertAttribute
					name="footer" /></td>
		</tr>
