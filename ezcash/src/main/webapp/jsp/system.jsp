 ...
 function autoRefresh()
{
 ...
 setInterval('autoRefresh()', 10000); // this will reload page after every 5 secounds; Method I
   ...
   <table >
	...
	<td>
	<img style= 'background-color: #84b4fb;'  src="<c:url value='/resources/img/user.png'/>" />
	</td>
	
	<td>	
	
	 <spring:url value="/logout" var="logoutUrl" htmlEscape="true"/>		  
	  <h4 style="margin-right:2px;font-family: Palatino Linotype;text-align: right;" >Admin : ${LoginUser} </h4>
	       </td>
	       <td>
	       <span style="font-family: Palatino Linotype;text-align: right;"><a href="${logoutUrl}" >LogOut</a></span>
	       </td>
	</tr>       
 </table>
