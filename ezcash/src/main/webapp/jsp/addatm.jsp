		...
		<form:form method="post" action="addAtm">
	       <tr>
			...
			<tbody>
					 ...
					 <h3 style="margin-left:2px;font-family: Palatino Linotype;text-align: left;" >Assigned Operators</h3>
			<table class="tablesorter">
			...
			<tbody>
	        			...
	        			<tr>
	        		<td ><a href="<c:url value='/removeAssignedAtmOperator/${atmop.assignId}' />" ><img src="<c:url value='/resources/img/delete.png'/>" /></a></td>
	        		<td>${atmop.assignId}</td>
					<td>${atmop.atm.atmName}</td>
					<td>${atmop.operator.operatorName}</td>
					<td><div class="text_div">${atmop.operator.operatorType}</div></td>
