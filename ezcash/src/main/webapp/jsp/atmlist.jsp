...
<body>
   ...
   <spring:url value="/${atm.atmName}" var="authenticatedUrl" htmlEscape="true"/>
           <div class="aAtm">					
   <a href="${authenticatedUrl}" class="a ${sessionScope.AtmTab eq atm.atmName?'currentTabAtm':'Tab'}"><span class="sapanAtm">${atm.atmName}</span></a>
   </div> 
            		</div>
        </li>  					
