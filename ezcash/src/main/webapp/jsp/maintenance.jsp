...
<body>
	...
	<!-- Reload -->
	<h3
		style="margin-left: 2px; font-family: Palatino Linotype; text-align: left;">Reload
		Tasks</h3>
		...
		<tbody>
			...
			<tr>
				<form:form method="post" action="addReload">
					...
					<td><input type="text" style="width: 100%" class="datetime"
						name="taskExpiryTime" required></td>

					<td><input type="text" size="10" class="text" name="tray1"
						required></td>

					<td><input type="text" size="10" class="text" name="tray2"
						required></td>
					<td></td>
